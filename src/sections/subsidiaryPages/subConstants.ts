...
export const sub_one = {
  ...
  connect_text:
    "Explore limitless possibilities with our solutions! Connect with our passionate team for tailored support on your triumphant journey. Contact us now to turn your dreams into reality!",
};
