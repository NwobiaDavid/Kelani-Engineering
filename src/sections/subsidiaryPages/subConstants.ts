...
export const sub_one = {
  ...
  features_data: {
    header:
      "Elevate Excellence: Strategize, Implement, and Optimize Engineering Dynamics at Scale for Unparalleled Industry Advancement",
    contents: [
      {
  ...
  slideshow_section: {
    ...
    btnColour:
      "linear-gradient(0deg, rgba(115, 82, 139, 0.9), rgba(37, 29, 45, 0.9) 99.78%);",
    content: [
      {
    ...
    text: {
      head: "unparalleled skill for informed strategies  immediate SOLUTIONS FOR knowledgeable DECISIONS",
      sub: "Pioneering Industrial Excellence",
    },
  },
  parallex_section: {
...
export const sub_two = {
  ...
  customerCards: [
    ...
    {
      img: "assets/images/engineering-clients/dingye-logo.png",
      height: 130,
    },
    {
      img: "assets/images/engineering-clients/gelgoog-logo.png",
      height: 105,
    },
    {
      img: "assets/images/engineering-clients/lishg-logo.png",
      height: 120,
    },
    {
      img: "assets/images/engineering-clients/technoshell-logo.png",
      height: 80,
    },
    {
      img: "assets/images/engineering-clients/tentoo-logo.png",
      height: 80,
    },
    {
      img: "assets/images/engineering-clients/tongjila-logo.png",
      height: 130,
    },
  ],
  hero_section: {
  ...
  features_data: {
    header:
      "Unlock potential: Building Excellence by striving for Industrial Transformation.",
    contents: [
      {
...
export const sub_three = {
  ...
  customerCards: [
    ...
    {
      img: "assets/images/power-clients/ekedc-logo.png",
      height: 100,
    },
    {
      img: "assets/images/power-clients/estNigeria.png",
      height: 130,
    },
    {
      img: "assets/images/power-clients/ikedc-logo.png",
      height: 95,
    },
    {
      img: "assets/images/power-clients/eedc-logo.png",
  ...
  slideshow_section: {
    ...
    btnColour:
      "linear-gradient(0deg, rgba(47, 71, 43, 0.8), rgba(81, 153, 72, 0.8) 99.78%);",
    content: [
      {
