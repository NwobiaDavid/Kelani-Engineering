            ...
            <div className=' w-[500px] 3xl:w-[55%] lg:w-[88%] flex-col relative flex justify-center items-center '>
                <Marquee pauseOnHover={true} className='border  border-opacity-40 border-white rounded-xl ' >
                  {cards.map((item, index)=>(
                      <div key={index} className='m-0 p-2 w-[150px] h-[100px] md:w-[250px] md:h-[170px] lg:h-[190px] lg:w-[260px] 3xl:h-[200px] 3xl:w-[270px] flex justify-center items-center border-white text-white border border-y-0 border-opacity-30 '>
