...
const CustomerSection: React.FC = () => {
  ...
  return (
    <div className="w-full h-[38rem] lg:h-fit bg-black">
      <div className='flex flex-col relative justify-center items-center'>
        ...
        <img src="assets/images/subsidiaryPagesImages/props/marquee-line-right.png" alt="" className='lg:absolute invisible lg:visible right-[8.3rem] top-[14.2rem]' />
          ...
          <div className='lg:h-[400px] h-[200px] w-[500px] lg:w-[70%] flex-col relative flex justify-center items-center '>
        <h1 className='text-white opacity-60 mb-6 font-semibold text-xs lg:text-base lg:mb-10'>CUSTOMERS</h1>
