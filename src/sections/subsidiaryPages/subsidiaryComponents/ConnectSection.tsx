...
const ConnectSection: React.FC = () => {
    return (
        <div className='bg-black rounded-b-3xl h-[650px] lg:h-screen relative flex justify-center items-center text-white '>
            <img className="absolute text-center  " src="/assets/images/subsidiaryPagesImages/props/Circles.png" alt="" />
            <div className='flex items-center justify-center flex-col h-full w-[90%] lg:w-[35%] text-center '>
