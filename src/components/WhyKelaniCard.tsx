...
const WhyKelaniCard = ({ icon, title, text, index }: WhyKelaniCardProps) => {
    ...
    return (
        <div style={{ borderRight: index == 1 ? "1px solid rgba(255,255,255,0.5)" : "", borderBottom: width < 768 && index == 1 ? "1px solid rgba(255,255,255,0.5)" : "" }} className="w-full flex flex-col px-[20px] lg:px-[48px] pt-[30px] lg:pt-[48px] pb-[30px] lg:pb-[60px]"
        >
            <img className="w-[140px] lg:w-[200px] lg:w-[240px] opacity-80" src={icon} />
